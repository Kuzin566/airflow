...
HOST = "smtp.yandex.ru"
TO = "kuzinairflow@yandex.ru"
FROM = "kuzinairflow@yandex.ru"
mail = 'kuzinairflow'
password = 'iklkyvhghhkbxiwy'
...
def _send_email(data, cred, host, port, to, From):
    ...
    server.quit()
    print('Успешно отправили данные на почту')
...
if __name__ == '__main__':
    ...
    # Send Email
    send_email(data, cred=(mail, password), host=HOST, port=587, to=TO, From=FROM)